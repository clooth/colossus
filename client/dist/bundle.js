...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/nico/Development/Games/colossus/client/src/main.js */191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Splash = __webpack_require__(/*! ./states/Splash */ 194);

	var _Splash2 = _interopRequireDefault(_Splash);

	var _Game = __webpack_require__(/*! ./states/Game */ 196);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Game).call(this, width, height, _phaser2.default.AUTO, 'content', null, false, false));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Character = __webpack_require__(/*! ../sprites/Character */ 197);

	var _Character2 = _interopRequireDefault(_Character);

	var _Random = __webpack_require__(/*! ../lib/Random.js */ 199);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.player = new _Character2.default({
	        game: this.game,
	        x: 32 * (0, _Random.randomIntInclusive)(0, 12),
	        y: 32 * (0, _Random.randomIntInclusive)(0, 12),
	        asset: 'character'
	      });
...
/* 197 */
/*!*****************************************!*\
  !*** ./client/src/sprites/Character.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Enum = __webpack_require__(/*! ../lib/Enum */ 198);
	...
	var Character = function (_Phaser$Sprite) {
	  ...
	  function Character(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Character).call(this, game, x, y, asset));

	    _this.game = game;

	    // Define all animations from spritesheet
	    _this.animations.add('walk-down', [0, 1, 2], 10, true);
	    _this.animations.add('walk-left', [12, 13, 14], 10, true);
	    _this.animations.add('walk-right', [24, 25, 26], 10, true);
	    _this.animations.add('walk-up', [36, 37, 38], 10, true);

	    _this.anchor.x = _this.anchor.y = 0.0;

	    // Initial state is just idle
	    _this.state = Character.State.Idle;

	    // Initially we're facing south
	    _this.facing = Character.Facing.South;

	    // The speed of acceleration
	    _this.speed = 256;

	    // The destination point to which we will move
	    _this.destination = new _phaser2.default.Point(x, y);
	  ...
	  _createClass(Character, [{
	    ...
	    key: 'handleIdleActions',
	    value: function handleIdleActions() {
	      // Shortcut to the keyboard manager
	      var keyboard = this.game.input.keyboard;

	      // Move up on W
	      if (keyboard.isDown(_phaser2.default.Keyboard.W)) {
	      ...
	      // Move east on D
	      else if (keyboard.isDown(_phaser2.default.Keyboard.D)) {
	        ...
	        // Move south on S
	        else if (keyboard.isDown(_phaser2.default.Keyboard.S)) {
	            this.destination.y += this.height;
	            this.state = Character.State.Moving;
	          ...
	          // Move west on A
	          else if (keyboard.isDown(_phaser2.default.Keyboard.A)) {
	              this.destination.x -= this.width;
	              this.state = Character.State.Moving;
	    ...
	    key: 'handleMovement',
	    value: function handleMovement(facing) {
	...
	Character.State = new _Enum2.default('Idle', 'Moving');

	// The direction the characters can be facing
	Character.Facing = new _Enum2.default('North', 'East', 'South', 'West');
...
/***/ function(module, exports) {
	...
	var randomIntInclusive = exports.randomIntInclusive = function randomIntInclusive(min, max) {
